...
final class StatusMenuController: NSObject {
    ...
    func configureStatusItem(_ statusItem: NSStatusItem, target: AppDelegate) {
        ...
        menu.addItem(makeMainWindowItem())
    ...
    private func makeMainWindowItem() -> NSMenuItem {
        let item = NSMenuItem(
            title: NSLocalizedString("打开播放器", comment: ""),
    ...
    private func registerNotifications() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(refresh), name: .trackChanged, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(refresh), name: .playbackStateChanged, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(refresh), name: .playlistUpdated, object: nil)
